...
const StatsComponent = (props: StatsComponentType) => {
    ...
    return (
      <View>
        {props.dataStats && props.dataStats.players.map((items: StatsItemType, index: number) => {
          return (
            <View key={index} style={{ paddingBottom: 16, borderBottomWidth: 1, borderColor: "#DEDEDE", paddingHorizontal: 16 }}>
  ...
  function _buildTrophiesView(nameUp: string, valueUp: string, idUp: number, nameDown: string, valueDown: string, idDown: number) {
    return (
      <View style={{ borderColor: '#DEDEDE', borderWidth: 1, borderRadius: 12 }}>
        <View style={{ flexDirection: 'row', padding: 16, alignItems: 'center', borderBottomWidth: 1, borderColor: '#DEDEDE' }}>
    ...
    return (
      <View style={{ backgroundColor: 'white' }}>
        {props.dataStats && props.dataStats.teams.map((items: StatsItemType, index: number) => {
          return (
            <View key ={index} style={{ paddingHorizontal: 16, borderBottomWidth: 1, borderColor: '#DEDEDE' }}>
